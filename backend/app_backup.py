...
def query_document():
    ...
    # Simulated logic to retrieve content from the document
    # Replace this with actual NLP later
    mock_response = {
        "answer": f"Mock answer to the question: '{question}' based on the uploaded document.",
